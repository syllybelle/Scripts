# Dictionary for timezones. Keys are the format used in Viedoc as well as some shorter forms.
# Values are the format required for API import. Excel file may contain both the keys and values.
tz_conversion = {
